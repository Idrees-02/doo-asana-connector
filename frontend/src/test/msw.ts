...
export const mockTask = {
  ...
  dueAt: null,
  startOn: null,
  assignee: { id: '900000000000101', name: 'Sam Rivera', email: 'sam@example.invalid' },
  workspace: { id: '900000000000001', name: 'Demo Workspace' },
  parent: null,
...
export const defaultHandlers = [
    ...
    HttpResponse.json({
      ...
      config: {
        ...
        mcp: {
          ...
          authReason: 'MCP_AUTH_TOKEN is configured; every request must present it as a bearer token.',
          publicUrl: null,
        },
  ...
  http.post('/api/connector/test', () =>
    HttpResponse.json({
      ...
      provider: 'asana',
      mode: 'demo',
      account: { id: '1', name: 'Sam Rivera', email: 'sam@example.invalid' },
